...
function setLanguage(lang) {
  ...
  const elements = [
    ...
    { id: 'pDesktop3', prop: 'innerText', key: 'pDesktop3' },
    // privacy.html
...
const translations = {
  en: {
    ...
    pApp3: "I am currently trying to publish the app on the Play Store, in the meanwhile you can download the apk from here:",
    pApp4: "Nutrack apk",
    h2Web: "Nutrack Web",
    ...
    pWeb2: "The files with install instructions are available on the public Github-Repo",
    pWeb3: "Github-Repository",
    ...
    pDesktop2: "Still in Development, the last update is available on the public Github-Repo",
    pDesktop3: "Github-Repository",
    // privacy.html
  ...
  de: {
    ...
    pApp3: "Momentan versuche ich die App auf dem Play Store zu veröffentlichen, in der Zwischenzeit kann man die apk hier herunterladen:",
    pApp4: "Nutrack apk",
    h2Web: "Nutrack Web",
    ...
    pWeb2: "Die Dateien dazu inklusive Installationsanleitung sind auf dem öffentlichen Github-Repo verfügbar",
    pWeb3: "Github-Repository",
    h2Desktop: "Nutrack Desktop App",
    ...
    pDesktop2: "Noch in Entwicklung, der letzte Stand ist auf dem öffentlichen Github-Repo einzusehen",
    pDesktop3: "Github-Repository",
    // privacy.html
